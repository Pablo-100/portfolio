        ...
        <section className="min-h-[80vh] flex flex-col-reverse md:flex-row items-center justify-center gap-16 md:gap-24 mb-16 md:mb-0">
          ...
          >
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="flex flex-wrap items-center gap-4 mt-4 font-mono text-sm">
              ...
              <a href="/cv.pdf" download="TBINI_Mustapha_Amin_CV_Final.docx.pdf" className="flex items-center gap-2 px-6 py-3 rounded-full bg-[var(--color-cyber-light)]/10 text-[var(--color-cyber-text-light)] border border-[var(--color-cyber-blue)] hover:bg-[var(--color-cyber-blue)]/20 transition-all hover:scale-105">
